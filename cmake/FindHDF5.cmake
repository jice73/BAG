...
#   HDF5_C_LIBRARY   - Required libraries for the HDF5 C bindings.
#   HDF5_CXX_LIBRARY - Required libraries for the HDF5 C++ bindings
#   HDF5_Fortran_LIBRARY - Required libraries for the HDF5 Fortran bindings
#   HDF5_HL_LIBRARY      - Required libraries for the HDF5 high level API
#   HDF5_Fortran_HL_LIBRARY - Required libraries for the high level Fortran
#                               bindings.
...
#
#  if a CMake installed HDF5 is located, the following vars are set when 
#  the corresponding libraries are found, by default the LIBRARY variable 
#  without the ${config} (RELEASE/DEBUG) tag will be set to the release 
...
#  (the targets are hdf5, hdf5_cpp, hdf5_hl, hdf5_fortran ... ) 
#  
#  HDF5_hdf5_LIBRARY             + HDF5_hdf5_LIBRARY_${config}       
#  HDF5_hdf5_cpp_LIBRARY         + HDF5_hdf5_cpp_LIBRARY_${config}   
#  HDF5_hdf5_hl_LIBRARY          + HDF5_hdf5_hl_LIBRARY_${config}    
#  HDF5_hdf5_hl_cpp_LIBRARY      + HDF5_hdf5_hl_cpp_LIBRARY_${config}  
#  HDF5_hdf5_tools_LIBRARY       + HDF5_hdf5_tools_LIBRARY_${config}  
#  HDF5_hdf5_f90cstub_LIBRARY    + HDF5_hdf5_f90cstub_LIBRARY_${config}
#  HDF5_hdf5_fortran_LIBRARY     + HDF5_hdf5_fortran_LIBRARY_${config} 
#  HDF5_hdf5_hl_f90cstub_LIBRARY + HDF5_hdf5_hl_f90cstub_LIBRARY_${config} 
#  HDF5_hdf5_hl_fortran_LIBRARY  + HDF5_hdf5_hl_fortran_LIBRARY_${config} 
    ...
    if( HDF5_FOUND )
        ...
        foreach( _component ${_libraries} )
            ...
            foreach( _config ${_configs} )
                ...
                endif ( WIN32 AND ${_type} MATCHES "SHARED")
                # message("Generated name is HDF5_${_component}_LIBRARY_${_config} = ${_comp_location}") 
                if( _comp_location )
                    set( HDF5_${_component}_LIBRARY_${_config} ${_comp_location} CACHE PATH
                        "HDF5_${_component}_LIBRARY_${_config} library" )
                    mark_as_advanced( HDF5_${_component}_LIBRARY_${_config} )
                    if ( ${_config} MATCHES "RELEASE")
                        set( HDF5_${_component}_LIBRARY ${_comp_location} CACHE PATH
                            "HDF5_${_component}_LIBRARY library" )
                        mark_as_advanced( HDF5_${_component}_LIBRARY )
                        list( APPEND HDF5_LIBRARIES ${HDF5_${_component}_LIBRARY} )
                    endif (${_config} MATCHES "RELEASE")
                endif()
            endforeach()
            IF(HDF5_ENABLE_PARALLEL)
                list( APPEND HDF5_LIBRARIES ${HDF5_MPI_C_LIBRARIES})
