...
namespace
{
    ...
    */
    //************************************************************************
    std::string datumToWkt(const bagDatum datum, const char *ellipsoid)
    {
        std::string ellipWkt;
...
bagError bagLegacyToWkt(const bagLegacyReferenceSystem system,
    char *hBuffer, uint32_t hBuffer_size,
    char *vBuffer, uint32_t vBuffer_size)
    try
{
    std::stringstream wktStream;
    wktStream.imbue(std::locale::classic());
